        ...
        <div className="max-w-[210mm] mx-auto bg-white min-h-[297mm] flex shadow-sm font-sans">
            ...
            <aside className="w-1/3 bg-slate-900 text-white p-6 flex flex-col">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-center leading-tight">{data.personal_info.fullName}</h1>
                    <p className="text-slate-400 text-sm mt-2 text-center">{data.personal_info.location}</p>
                </div>
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <div className="space-y-2 text-sm text-slate-300 break-words">
                            ...
                            {data.personal_info.linkedinUrl && <a href={data.personal_info.linkedinUrl} className="block text-blue-400 hover:text-blue-300 truncate">LinkedIn</a>}
                            {data.personal_info.portfolioUrl && <a href={data.personal_info.portfolioUrl} className="block text-blue-400 hover:text-blue-300 truncate">Portfolio</a>}
                        </div>
                    </div>
                    ...
                    <div>
                        <h3 className="text-xs uppercase tracking-widest text-slate-400 border-b border-slate-700 pb-2 mb-3">Languages</h3>
